...
void eff_sprite(SDL_Surface *ecran, int type, _vaisseau *vaisseau, SDL_Surface *save_screen);
SDL_Rect* aff_sprite(SDL_Surface *ecran, int type, _vaisseau *vaisseau, SDL_Surface* save_screen);
